...
export class AdminLocalAuthGuard extends AuthGuard('admin-local') {
  ...
  constructor() {
    ...
    this.logger.log(
      'AdminLocalAuthGuard: CONSTRUCTOR CALLED (using Nest Logger)',
    ); // Optionnel
  }
  ...
  canActivate(context: ExecutionContext) {
    ...
    this.logger.log(
      'AdminLocalAuthGuard: CANACTIVATE CALLED (using Nest Logger)',
    ); // Optionnel
  ...
  getRequest(context: ExecutionContext) {
    ...
    this.logger.log(
      'AdminLocalAuthGuard: GETREQUEST CALLED (using Nest Logger)',
    ); // Optionnel

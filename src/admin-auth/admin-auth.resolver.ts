...
import {
  AdminLoginInput,
  AdminLoginResponse,
} from '../admins/dto/admin-login.input';
...
import {
  RequestAdminPasswordResetInput,
  ResetAdminPasswordInput,
} from '../admins/dto/admin-password-reset.input';
...
export class AdminAuthResolver {
  ...
  @Mutation(() => Boolean, {
    name: 'requestAdminPasswordReset',
  ...
  async requestAdminPasswordReset(
    ...
    await this.adminAuthService.requestPasswordReset(
      requestAdminPasswordResetInput.email,
    );
  ...
  @Mutation(() => AdminUser, {
    ...
    description: 'Resets the admin password using a token.',
  })
  ...
  @Mutation(() => Boolean, {
    ...
    description: 'Checks if an admin JWT is valid.',
  })
  ...
  @Query(() => AdminUser, {
    name: 'adminMe',
    description: 'Gets the currently authenticated admin user.',
  })
  async adminMe(
